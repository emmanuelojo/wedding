<template>
  <section class="relative py-20 md:py-28 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 text-center">
      <h3
        ref="titleRef"
        class="font-serif text-3xl md:text-4xl text-white mb-12 tracking-wide"
      >
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
        ...
        >
          <div class="glass-card rounded-xl py-6 px-4">
            <span class="font-serif text-4xl md:text-5xl text-olive-600">{{
              unit.value
            }}</span>
            <p class="text-white/50 text-xs tracking-[0.2em] uppercase mt-2">
              {{ unit.label }}
            </p>
          </div>
        </div>

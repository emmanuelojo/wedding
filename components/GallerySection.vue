<template>
  <section
    id="gallery"
    class="relative py-24 md:py-32 bg-nude-500/10 overflow-hidden"
  >
    <div class="max-w-7xl mx-auto px-6 md:px-12">
      ...
      >
        ...
        >
          <div
            class="w-10 h-10 rounded-full bg-lilac-500/20 backdrop-blur-sm flex items-center justify-center animate-pulse"
          >
            <svg
